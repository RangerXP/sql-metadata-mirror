...
> `nb_XX` → current-name mapping table, see `docs/07-10_Notebook_Description_pending.md`
...
> Live-validation findings sections, and `docs/07-10_Notebook_Description_pending.md`'s
