...
| G2-3 | Define which views/procs carry business semantics | 🔴 Not Started — superseded by `nb_07a` glossary/CDE ingestion path | Glossary terms now live in `purview/glossary-master.csv`, not SQL views |
