...
| `lh_metadata.governance_change_requests` | Table (8 rows) | Gated-approval request records (KPI, verified-answer, CDE, glossary-term scenarios) | Feeds `07_apply_approved_changes`'s "click Approve → watch the data change" demo moment |
