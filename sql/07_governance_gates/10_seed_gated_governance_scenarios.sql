...
(
    ...
    N'{"term_code":"GT-SLA","term_name":"Service Level Agreement","parent_term_code":null,"domain_code":"DOM-SVCDEL","owner_upn":"ranbir.singh@enercare.ca","additional_owners_upn":"Ci.Zhu@enercare.ca","definition":"Committed service response window by request type and season (e.g., 24-hour no-heat SLA during heating season) with an associated pro-rated daily credit remedy on breach, per the Total Home Protection Plan contract terms.","status":"Published","is_cde":0,"industry_origin":"Service Industry","resources":"internal://sla/policy","bound_assets":"dbo.contracts;dbo.service_requests","domain":"DOM-SVCDEL","owner":"ranbir.singh@enercare.ca","sensitivity":"Internal","semantic_role":"glossary_term","business_use":"SLA policy definition for service credit calculations"}',
    NULL,
