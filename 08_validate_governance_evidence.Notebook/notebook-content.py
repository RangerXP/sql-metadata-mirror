...
# Shared with 05/06's Purview sign-in: if either notebook already cached a valid
# token in this run window, reuse it instead of blocking on interactive sign-in.
